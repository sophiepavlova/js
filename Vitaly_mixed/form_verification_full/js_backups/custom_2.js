...
form.onsubmit = function (event) {
  ...
  } else if (!isValidUsername(nameLog.value)) {
    error = true;
    messageName.classList.remove("hidden");
...
//2. Сообщение об успешной отправке должно быть или черным или зеленым, но не красным
...
//5. Сделать красивее
//6. сделать шапку-заголовок

//---Вопросы
//1. Сейчас во всех формах есть упрощенные варианты логина или sign-up. например, через google или фейсбук. Как это сделать?
//2. Может, сразу и sing-up и log-in сделать?
//3. Сейчас, если отправить пустую форму, выдаются сразу все сообщения об ошибках под всеми полями. Может стоит их показывать только, если в полу действительно что-то делали? Или нормально, как подсказка?
